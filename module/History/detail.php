...
<div class="card mb-3">
    <div class="card-body">
        <a href="?page=module/History/index" class="btn btn-primary ">Kembali</a>
        <a href="cetak_satu.php?id=<?php echo $id ?>" target="_blank" class="btn btn-success ">Cetak</a>
        <br><br>
        <center>
